...
public class CustomErrorHandler extends ResponseEntityExceptionHandler implements Constants {
    ...
    public ResponseEntity<Object> userNotFoundException(Exception ex, WebRequest request) throws Exception {
        return getResponseEntity(request, HttpStatus.NOT_FOUND, ex, null);
    }

    @ExceptionHandler(CartExistsException.class)
    public ResponseEntity<Object> cartExistsException(Exception ex, WebRequest request) throws Exception {
        return getResponseEntity(request, HttpStatus.BAD_REQUEST, ex, null);
    }

    @ExceptionHandler(CartNotFoundException.class)
    public ResponseEntity<Object> cartNotFoundException(Exception ex, WebRequest request) throws Exception {
        return getResponseEntity(request, HttpStatus.NOT_FOUND, ex, null);
    }
